...
#define CLADE_NUM ((int)(sizeof(CLADE_LIST)/sizeof(Clade)))


/* list of predefined clades */
...
/* ensure that the number of clades can be represented by an int */
static_assert((sizeof(CLADE_LIST)/sizeof(Clade)) <= (size_t)INT_MAX);
