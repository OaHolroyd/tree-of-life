...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- 1. Complex Dummy Database (Includes a 5+ child cluster) ---
  const CLADE_DATABASE = {
    1: {
      tid: 1,
      ptid: null,
      visible: true,
    ...
    // These nodes start HIDDEN and will be injected smoothly later
    4: {
      tid: 4,
      ptid: 3,
      visible: false,
    ...
    6: {
      ...
      sci_name: "Placozoa",
      com_name: "Placozoans",
      text: "Basal form of multicellular organism.",
      image: "https://via.placeholder.com/300",
    },
    7: {
      tid: 7,
      ...
      text: "Mouth develops from blastopore.",
      image: "https://via.placeholder.com/300",
    },
    8: {
      tid: 8,
      ...
      text: "Anus develops from blastopore.",
      image: "https://via.placeholder.com/300",
    },
  };
