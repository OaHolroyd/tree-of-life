...
export const CLADE_LIST = [
  ...
  new Clade(
    ...
    "Allotriocarida",
    "",
    "Allotriocarida (from classical Greek ἀλλότριος/allotrios 'different, foreign' and καρίς/karis 'shrimp, crustacean') is a clade of Pancrustacea, containing Hexapoda (all insects, springtails, and their close relatives). It also contains three non-hexapod classes: Remipedia (blind, venomous crustaceans), Cephalocarida (translucent aquatic detrivores), and Branchiopoda (freshwater, non-decapod 'shrimp'). One study also found the Copepoda to be part of Allotriocarida.",
  ...
  new Clade(
    ...
    "Lacertoidea",
    "",
    "The Lacertoidea is a group of squamate reptiles that includes the Lacertidae, Teiidae, Gymnophthalmidae, and Amphisbaenia. The finding from molecular phylogenetic studies that the burrowing Amphisbaenia were nested in a clade with the lizard forms led Vidal and Hedges (2005) to propose a new name for the group based on shared morphogical characters, Laterata, 'referring to the presence of tile-like (squarish or quadrangular, and sometimes raised) scales that form the rings in Amphisbaenia, and are also present ventrally in Lacertiformata and Teiformata'.",
  ...
  new Clade(
    ...
    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Familia_Canidae.jpg/500px-Familia_Canidae.jpg",
    "Family",
  ),
  new Clade(
    439,
  ...
  new Clade(
    ...
    "Agreodontia",
    "",
    "Agreodontia is a clade (or superorder) of Australian marsupials that includes three living orders: the carnivorous marsupials (such as quolls and the Tasmanian devil), bandicoots and bilbies, and marsupial moles. It excludes the diprotodont marsupials, such as kangaroos, koalas, and wombats. Agreodontia was proposed based on modern genetic and anatomical evidence showing that these three groups share a more recent common ancestor with each other than with other marsupials.",
  ...
  new Clade(
    ...
    "Paracanthopterygii",
    "",
    "Paracanthopterygii is a superorder of fishes. Members of this group are called paracanthopterygians. The oldest members are known as fossils from the Cenomanian. It includes three extant orders: Percopsiformes (trout-perches and allies), Zeiformes (dories), and Gadiformes (cods and allies, including Stylephoriformes).",
